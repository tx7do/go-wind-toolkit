...
func (g *GoCmd) RunUpwardUntilSucceeds(ctx context.Context, startDir string, args ...string) ([]byte, error) {
	return g.RunUpwardUntilValid(ctx, startDir, nil, args...)
}
...
func (g *GoCmd) RunUpwardUntilValid(ctx context.Context, startDir string, valid func(out []byte) bool, args ...string) ([]byte, error) {
	dir := startDir
	if dir == "" {
		wd, err := os.Getwd()
		if err != nil {
